//! Resolve dictionary directions and enforce the lookup deadline.

use crate::lookup::{LookupError, LookupRequest, validate_query};
use crate::{
    domain::{INITIAL_PAIRS, Language, LanguagePair, LookupResult},
...
mod tests {
    use super::*;
    use crate::{domain::ResultKind, lookup::ProviderCapabilities};
    use std::sync::{
        Arc,

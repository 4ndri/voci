...
use crate::domain::{Language, LanguagePair};
use crate::lookup::{LookupError, LookupRequest, validate_query};
...
pub enum Command {
    ...
    Completions {
        #[arg(value_enum)]
        shell: crate::cli::completion::Shell,
    },
...
impl From<ProviderArg> for ProviderName {
    fn from(value: ProviderArg) -> Self {
        match value {
            ProviderArg::Wikdict => Self::Wikdict,
            ProviderArg::Microsoft => Self::Microsoft,
        }
    }
}
